  ...
  function wire(){
    document.querySelectorAll(".tab").forEach(function(tb){tb.addEventListener("click",function(){document.querySelectorAll(".tab").forEach(function(x){x.classList.remove("active");});tb.classList.add("active");["today","tasks","routine","wins"].forEach(function(n){$("tab-"+n).classList.add("hidden");});$("tab-"+tb.getAttribute("data-tab")).classList.remove("hidden");});});
